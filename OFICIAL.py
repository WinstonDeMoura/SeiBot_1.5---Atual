...
if datahoje < ('2023-10-02'):
  ...
  expirou = pyautogui.alert(text="Programa Expirou. Baixe-o novamente do site", title='Programa Expirou')
  if expirou:
    import webbrowser
    webbrowser.open('https://sites.google.com/view/sei-bot/in%C3%ADcio')