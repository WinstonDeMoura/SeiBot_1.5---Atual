...
um pouco. Me isento de quaisquer problemas que possa ter pelo mal uso da ferramenta!""", title='AVISO')
  ...
  def Enviar_Msg():
    ...
    pyautogui.alert(text='Clique em Ok para começar a enviar as mensagens', title='Começar Programa', button=('OK'))
  ...
  # alerta = Label(app,text="""Por favor, evite colocar muitos números nessa lista.
  # O WhatsApp não gosta de automação. O robô simula a interação humana, por isso demora
  # um pouco. Com esse aviso dado, fique avontade para usar!""",anchor=N)
  # alerta.place(x=10,y=10)

  # ________________ TENTATIVA DE DEIXAR A IMAGEM NO .EXE_______________________##
  # logo = Image.open(r'C:\Users\winst\OneDrive - Church of Jesus Christ\CODE\PYTHON\SeiBot_1.0 - Atual\img\logoapp.png')
  # logoload = ImageTk.PhotoImage(logo)


  # img = PhotoImageKO(file=r'logoapp.png')
